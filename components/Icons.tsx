...
// A generic icon props interface if you need to standardize them
interface IconProps {
  className?: string;
}
...
export const SparklesIcon = ({ className = 'w-5 h-5' }: IconProps) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m1-9l2-2 2 2m-2-2v6m-4 4l2 2 2-2m-2 2v-6m6-3l2-2 2 2m-2-2v6m-4 4l2 2 2-2m-2 2v-6"></path></svg>
);
